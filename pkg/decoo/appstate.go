...
// The AppState must have a well-defined hash. For this, the AppState is marshaled into json and the resulting bytes
...
// MarshalBinary provides deterministic marshaling of the state.
